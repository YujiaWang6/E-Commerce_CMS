...
<body>
    ...
    <section class="w3-padding">
            <h2>Edit Category</h2>
            <form action="/console/categories/edit/<?=$category->id?>" method="post" novalidate class="w3-margin-bottom">
                <?= csrf_field() ?>

                <div class="w3-margin-bottom">
                    <label for="categoryName">Category Name:</label>
                    <input type="text" id="categoryName" name="categoryName" required value="<?= old('categoryName',$category->categoryName) ?>">
                ...
                <button type="submit" class="w3-button w3-green">Edit Category</button>
