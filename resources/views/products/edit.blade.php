...
<body>
    ...
    <section class="w3-padding">
            <h2>Edit Product</h2>
            <form action="/console/products/edit/<?= $product->id ?>" method="post" novalidate class="w3-margin-bottom">
                <?= csrf_field() ?>

                <div class="w3-margin-bottom">
                    <label for="productName">Product Name:</label>
                    <input type="text" id="productName" name="productName" required value="<?= old('productName',$product->productName) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="text" id="description" name="description" required value="<?= old('description',$product->description) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="url" id="url" name="url" required value="<?= old('url',$product->url) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="text" id="image" name="image" required value="<?= old('image',$product->image) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="number" id="stockQuantity" name="stockQuantity" required value="<?= old('stockQuantity',$product->stockQuantity) ?>">
                ...
                <button type="submit" class="w3-button w3-green">Edit Product</button>
